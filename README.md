...
The latest `dlordinal` release is `v2.4.3`. You can view all the changes made in the current and previous versions in the [CHANGELOG](./CHANGELOG.md).
...
`dlordinal v2.4.3` is the last version, supported from Python 3.8 to Python 3.12.
